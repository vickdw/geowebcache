...
package org.geowebcache.restng.layers;
...
import org.geowebcache.restng.controller.TileLayerController;
...
public class TileLayerRestTest {
    ...
    public void testGetList() throws Exception {
        this.mockMvc.perform(get("/restng/layers.xml")
    ...
    public void testPut() throws Exception {
        ...
        this.mockMvc.perform(put("/restng/layers/newLayer1.xml")
                .contentType(MediaType.APPLICATION_ATOM_XML)
                .contextPath("/restng")
                .content(layerXml))
        .andExpect(status().is2xxSuccessful());
        ...
        this.mockMvc.perform(put("/restng/layers/newLayer2.xml")
                .contentType(MediaType.APPLICATION_ATOM_XML)
                .contextPath("/restng")
                .content(layerXml2))
                .andExpect(status().is2xxSuccessful());
    ...
    public void testDelete() throws Exception {
        ...
        this.mockMvc.perform(delete("/restng/layers/" + layerName)
                .contextPath("/restng"))
                .andExpect(status().is2xxSuccessful())
